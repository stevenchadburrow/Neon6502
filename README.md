...
- Jan 2025: Wanting to create a handheld device of some kind, I created "Mon Catcher" using a PIC24 and a small LCD.  It was going to be a dedicated device that would act similar to Pokemon GO, using sensors to detect movement.  It worked, but I got bored of it quickly. ( No links provided. )
