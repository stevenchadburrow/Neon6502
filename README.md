...
- Oct 2024: I upgraded to the PIC32 micrcontroller called the "Acolyte Hand PIC'd 32" with absolutely stunning results <a href="https://github.com/stevenchadburrow/AcolyteHandPICd32">here</a>.  I started running it at 200 MHz, displaying 256 colors.  I bodged in better audio capabilities using an R2R DAC and was able to play video/audio streams.
...
- Jan 2025: Wanting to create a handheld device of some kind, I created "Mon Catcher" using a PIC24 and a small LCD.  It was going to be a dedicated device that would act similar to Pokemon GO, using sensors to detect movement.  It worked, but I got bored of it quickly.
